...
- Reusable component classes (`.card`, `.tag`, `.btn-primary`, `.rail`, `.portrait-ring`, `.waterline`, `.depth-rail`, `.seabed`) live in `@layer components`. Use Tailwind utilities inline for layout/spacing. No CSS modules, no styled-components.
